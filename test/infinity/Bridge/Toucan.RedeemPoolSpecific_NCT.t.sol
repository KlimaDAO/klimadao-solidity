...
contract RedeemToucanPoolDefaultNCTTest is TestHelper, AssertionHelper {
    ...
    function test_toucanRedeemPoolSpecific_redeemNCT_usingNCT_fuzz(uint redeemAmount) public {
        redeemNCT(NCT, redeemAmount);
    }

    function test_toucanRedeemPoolSpecific_redeemNCT_usingUSDC_fuzz(uint redeemAmount) public {
        redeemNCT(USDC, redeemAmount);
    }

    function test_toucanRedeemPoolSpecific_redeemNCT_usingKLIMA_fuzz(uint redeemAmount) public {
        redeemNCT(KLIMA, redeemAmount);
    }

    function test_toucanRedeemPoolSpecific_redeemNCT_usingSKLIMA_fuzz(uint redeemAmount) public {
        redeemNCT(SKLIMA, redeemAmount);
    }

    function test_toucanRedeemPoolSpecific_redeemNCT_usingWSKLIMA_fuzz(uint redeemAmount) public {
