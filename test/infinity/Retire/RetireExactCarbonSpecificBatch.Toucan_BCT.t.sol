...
contract RetireExactCarbonSpecificBatchToucanBCT is TestHelper, AssertionHelper {
    ...
    function test_infinity_retireExactCarbonSpecificBatch_BCT_BCT(uint256 retireAmount, uint256 retireAmount2) public {
        retireExactBCT(BCT, retireAmount, retireAmount2);
    }

    function test_infinity_retireExactCarbonSpecificBatch_BCT_USDC(uint256 retireAmount, uint256 retireAmount2)
        public
    {
        retireExactBCT(USDC, retireAmount, retireAmount2);
    }

    function test_infinity_retireExactCarbonSpecificBatch_BCT_KLIMA(uint256 retireAmount, uint256 retireAmount2)
        public
    {
        retireExactBCT(KLIMA, retireAmount, retireAmount2);
    }

    function test_infinity_retireExactCarbonSpecificBatch_BCT_SKLIMA(uint256 retireAmount, uint256 retireAmount2)
        public
    {
        retireExactBCT(SKLIMA, retireAmount, retireAmount2);
    }

    function test_infinity_retireExactCarbonSpecificBatch_BCT_WSKLIMA(uint256 retireAmount, uint256 retireAmount2)
        public
    {
    ...
    function retireExactBCT(address sourceToken, uint256 retireAmount, uint256 retireAmount2) public {
        ...
        vm.assume(retireAmount2 < (IERC20(BCT).balanceOf(SUSHI_LP) * 30) / 100);
        ...
        uint256 poolBalance1 = IERC20(batch[0].projectToken).balanceOf(BCT);
        uint256 poolBalance2 = IERC20(batch[1].projectToken).balanceOf(BCT);
