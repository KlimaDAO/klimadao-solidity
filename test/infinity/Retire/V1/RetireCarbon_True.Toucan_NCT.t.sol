...
contract RetireCarbonTrueToucanNCT is TestHelper, AssertionHelper {
    ...
    function test_infinity_v1_retireCarbon_True_NCT_NCT(uint retireAmount) public {
        retireExactBCT(NCT, retireAmount);
    }

    function test_infinity_v1_retireCarbon_True_NCT_USDC(uint retireAmount) public {
        retireExactBCT(USDC, retireAmount);
    }

    function test_infinity_v1_retireCarbon_True_NCT_KLIMA(uint retireAmount) public {
        retireExactBCT(KLIMA, retireAmount);
    }

    function test_infinity_v1_retireCarbon_True_NCT_SKLIMA(uint retireAmount) public {
        retireExactBCT(SKLIMA, retireAmount);
    }

    function test_infinity_v1_retireCarbon_True_NCT_WSKLIMA(uint retireAmount) public {
