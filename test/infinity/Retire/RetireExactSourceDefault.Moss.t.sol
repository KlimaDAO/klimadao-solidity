...
contract RetireExactSourceDefaultMoss is TestHelper, AssertionHelper {
    ...
    function test_retireExactSourceDefault_MCO2_USDC(uint retireAmount) public {
        retireExactMoss(USDC, retireAmount);
    }

    function test_retireExactSourceDefault_MCO2_KLIMA(uint retireAmount) public {
        retireExactMoss(KLIMA, retireAmount);
    }

    function test_retireExactSourceDefault_MCO2_SKLIMA(uint retireAmount) public {
        retireExactMoss(SKLIMA, retireAmount);
    }

    function test_retireExactSourceDefault_MCO2_WSKLIMA(uint retireAmount) public {
