...
contract RetireExactCarbonDefaultBatchToucanNCT is TestHelper, AssertionHelper {
    ...
    function test_infinity_retireExactCarbonDefaultBatch_NCT_NCT(uint256 retireAmount, uint256 retireAmount2) public {
        retireExactNCT(NCT, retireAmount, retireAmount2);
    }

    function test_infinity_retireExactCarbonDefaultBatch_NCT_USDC(uint256 retireAmount, uint256 retireAmount2) public {
        retireExactNCT(USDC, retireAmount, retireAmount2);
    }

    function test_infinity_retireExactCarbonDefaultBatch_NCT_KLIMA(uint256 retireAmount, uint256 retireAmount2)
        public
    {
        retireExactNCT(KLIMA, retireAmount, retireAmount2);
    }

    function test_infinity_retireExactCarbonDefaultBatch_NCT_SKLIMA(uint256 retireAmount, uint256 retireAmount2)
        public
    {
        retireExactNCT(SKLIMA, retireAmount, retireAmount2);
    }

    function test_infinity_retireExactCarbonDefaultBatch_NCT_WSKLIMA(uint256 retireAmount, uint256 retireAmount2)
        public
    {
    ...
    function retireExactNCT(address sourceToken, uint256 retireAmount, uint256 retireAmount2) public {
        ...
        vm.assume(retireAmount2 < (IERC20(NCT).balanceOf(SUSHI_LP) * 50) / 100);
        vm.assume(retireAmount + retireAmount2 <= IERC20(DEFAULT_PROJECT).balanceOf(NCT));
