...
contract KlimaTreasury is Ownable {
    ...
    uint256 public sKLIMAQueue; // Delays change to sKLIMA address
    ...
    function incurDebt(uint256 _amount, address _token) external {
        ...
        uint256 maximumDebt = IERC20(sKLIMA).balanceOf(msg.sender); // Can only borrow against sKLIMA held
    ...
    function queue(MANAGING _managing, address _address) external onlyManager returns (bool) {
        ...
        } else if (_managing == MANAGING.SKLIMA) {
            // 9
