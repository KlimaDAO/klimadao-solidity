...
*See [IERC20-balanceOf](/src/protocol/tokens/regular/sKlimaToken_v2.sol/interface.IERC20.md#balanceof).*
...
*See [IERC20-transfer](/src/protocol/tokens/regular/sKlimaToken_v2.sol/interface.IERC20.md#transfer).
Requirements:
...
*See [IERC20-allowance](/src/protocol/tokens/regular/sKlimaToken_v2.sol/interface.IERC20.md#allowance).*
...
*See [IERC20-approve](/src/protocol/tokens/regular/sKlimaToken_v2.sol/interface.IERC20.md#approve).
Requirements:
...
*See [IERC20-transferFrom](/src/protocol/tokens/regular/sKlimaToken_v2.sol/interface.IERC20.md#transferfrom).
