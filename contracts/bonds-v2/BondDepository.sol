...
/// @title Klima O̶l̶y̶m̶p̶u̶s̶ Bond Depository V2
/// @author Zeus, Indigo
/// Review by: JeffX
...
contract KlimaBondDepositoryV2 is IBondDepository, NoteKeeper {
     ...
     * @return payout_     the amount of wsKLIMA due
        ...
        )
    {
         ...
         * price = quote tokens : klima (i.e. 42069 DAI : KLIMA)
         *
         ...
         *
         * this is either the number of KLIMA that the market can sell
        ...
        // purchased, and how much KLIMA has been sold
    ...
    function _tune(uint256 _id, uint48 _time) internal {
        ...
        if (_time >= meta.lastTune + meta.tuneInterval) {
            ...
            // klima decimals (9) + price decimals (9)
     ...
     * @param _market      [capacity (in KLIMA or quote), initial price / KLIMA (9 decimals), debt buffer (3 decimals)]
     ...
     * @param _id          ID of market
     * @return             amount of KLIMA to be paid in KLIMA decimals
     *
     ...
     * @param _id          ID of market
     * @return             current debt for market in KLIMA decimals
     */
     ...
     * @param _id          ID of market
     * @return             control variable for market in KLIMA decimals
     */
