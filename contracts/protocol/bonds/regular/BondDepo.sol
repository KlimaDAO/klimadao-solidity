...
contract KLIMAPrincipleDepository is IPrincipleDepository, Ownable {
    ...
    address public principleToken; // KLIMA-DAI LP
    ...
    function initialize ( address principleToken_, address KLIMA_ ) external onlyOwner() returns ( bool ) {
    ...
    function _depositBondPrinciple( uint amountToDeposit_ ) internal returns ( bool ){
        ...
        ITreasury( treasury ).depositPrinciple( amountToDeposit_ ); // Returns KLIMA
