...
contract RetireCarbonFacet is ReentrancyGuard {
    ...
    function retireExactCarbonDefault(
        ...
        if (sourceToken == poolToken) require(totalCarbon == maxAmountIn, "Incorrect pool amount");
        ...
        if (sourceToken != poolToken) {
            ...
            uint256 carbonReceived = LibSwap.swapToExactCarbonDefault(sourceToken, poolToken, maxAmountIn, totalCarbon);
