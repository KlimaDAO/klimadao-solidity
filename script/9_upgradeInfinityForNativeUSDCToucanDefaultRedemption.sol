...
contract UpgradeInfinityForNativeUSDCToucanDefaultRedemption is Script, HelperContract {
    function run() external returns (bytes memory) {
        ...
        RedeemToucanPoolFacet redeemToucanPoolF = new RedeemToucanPoolFacet();
        ...
        console2.log("New redeemToucanPoolF address");
