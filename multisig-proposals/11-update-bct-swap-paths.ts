...
const transactions: MetaTransactionData[] = [
  {
    ...
    value: "0",
    data: "0x", // swap paths calldata generated by upgrade script
    operation: OperationType.Call,
  },
  {
    to: RETIREMENT_AGGREGATOR,
    value: "0",
    data: "0x", // facet replacement calldata (RetirementQuoter, RetireCarbonFacet, RetireSourceFacet, RedeemToucanPoolFacet, RedeemC3PoolFacet) from upgrade script
    operation: OperationType.Call,
  },
];
